function getYelpWidget(id,width,color,image,styled,reviewnum){
  ...
  if (xmlHttp.readyState==4 && xmlHttp.status==200)
    {
    document.getElementById('yelpwidget_cabocantina').innerHTML= xmlHttp.responseText;
    }
  };
    ...
    if(typeof XDomainRequest !== "undefined"){
      ...
      xdr.onload = function() {
        document.getElementById('yelpwidget_cabocantina').innerHTML= xdr.responseText;
      };
